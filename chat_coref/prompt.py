...
3. Documents Required: ALWAYS provide a complete, practical list of required documents (e.g., Aadhaar Card, Bank Passbook, Income/Caste Certificate, Ration Card, Domicile Proof, Land Records/Student ID). NEVER output "Not specified".
